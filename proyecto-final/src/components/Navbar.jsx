    ...
    return (
      <nav className={styles.nav}>
        ...
        <ul className={styles.ul}>
          <li className="hover:text-[#19899B] cursor-pointer select-none"><NavLink to="/" className={({ isActive }) => isActive ? "text-[#19899B]" : ""}>Inicio</NavLink></li>
          <li className="hover:text-[#19899B] cursor-pointer select-none"><NavLink to="/nosotros" className={({ isActive }) => isActive ? "text-[#19899B]" : ""}>Nosotros</NavLink></li>
          <li className="hover:text-[#19899B] cursor-pointer select-none"><NavLink to="/servicios" className={({ isActive }) => isActive ? "text-[#19899B]" : ""}>Servicios</NavLink></li>
          <li className="hover:text-[#19899B] cursor-pointer select-none"><NavLink to="/contacto" className={({ isActive }) => isActive ? "text-[#19899B]" : ""}>Contacto</NavLink></li>
        </ul>
